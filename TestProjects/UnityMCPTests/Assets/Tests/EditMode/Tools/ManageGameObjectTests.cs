...
namespace MCPForUnityTests.Editor.Tools
{
    public class ManageGameObjectTests
    {
        ...
        public void ComponentResolver_Integration_WorksWithRealComponents()
        {
            ...
            var transformResult = ComponentResolver.TryResolve("Transform", out var transformType, out var error);
        ...
        public void ComponentResolver_Integration_WorksWithBuiltInComponents()
        {
            ...
            {
                var result = ComponentResolver.TryResolve(componentName, out var actualType, out var error);
